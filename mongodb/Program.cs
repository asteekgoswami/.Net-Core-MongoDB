    ...
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddIdentity<ApplicationUser, MongoIdentityRole>()
                .AddMongoDbStores<ApplicationUser, MongoIdentityRole, Guid>(
                    "mongodb+srv://asteekgoswami:admin000@dotnet.wbb2hns.mongodb.net/?retryWrites=true&w=majority", // Replace with your MongoDB connection string
                    "SchoolDb") // Replace with your MongoDB database name
